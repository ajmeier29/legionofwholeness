    ...
    return (
        <>
            <div className="min-h-screen flex items-center justify-center">
                <div className="relative grid grid-cols-1 content-center bg-hero-image bg-cover bg-bottom h-[700px] my-4 mx-3 md:mx-32 xl:mx-56 rounded-lg overflow-hidden">
